								...
								<div class="form-section-right column" id="blk-photos">
									...
									<div class="grid cols-2">
										<div class="field">
											...
											<input id="photo_hitch" name="photo_hitch" required type="file" accept="image/*" multiple />
										...
										<div class="field">
											<label class="req" for="photo_rear">Towing Vehicle Rear
												Photograph</label>
											<input id="photo_rear" name="photo_rear" required type="file" accept="image/*" multiple />
										...
										<div class="field">
											...
											<input id="photo_front" name="photo_front" required type="file" accept="image/*" multiple />
