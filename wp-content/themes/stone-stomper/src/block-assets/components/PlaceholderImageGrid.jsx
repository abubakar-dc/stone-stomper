...
import './global.scss';
const PlaceholderImageGrid = ( { props, valueImage, attrImage, className, ParentClassName } ) => {
	const {
		setAttributes,
	} = props;
	let innerImages;
					...
					render={ ( { open } ) => {
						...
						return (
							...
							<div className="image-box">
								<div className="image-grid-placeholders" onClick={ open }>
									<div className="dc-placeholder-image-grid" >
