							...
							<PanelRow>
								<SelectControl
									...
									options={ [
										...
										{ label: '2px', value: 'st-s2' },
										{ label: '4px', value: 'st-s4' },
										{ label: '6px', value: 'st-s6' },
										{ label: '8px', value: 'st-s8' },
										{ label: '12px', value: 'st-s12' },
										{ label: '16px', value: 'st-s16' },
										{ label: '20px', value: 'st-s20' },
										{ label: '24px', value: 'st-s24' },
										{ label: '30px', value: 'st-s30' },
										{ label: '36px', value: 'st-s36' },
										{ label: '48px', value: 'st-s48' },
										{ label: '56px', value: 'st-s56' },
										{ label: '60px', value: 'st-s60' },
										{ label: '72px', value: 'st-s72' },
										{ label: '80px', value: 'st-s80' },
										{ label: '120px', value: 'st-s120' },
										{ label: '128px', value: 'st-s128' },
										{ label: '156px', value: 'st-s156' },
										{ label: '200px', value: 'st-s200' },
										{ label: '240px', value: 'st-s240' },
									] }
									onChange={ ( value ) =>
										setAttributes( {
											marginTop: value,
