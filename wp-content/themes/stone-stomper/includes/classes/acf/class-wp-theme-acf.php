...
class WP_Theme_Acf {
	...
	public function include_acf_fields() {
		...
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Block_Label' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Headings' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Spacer' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Spacers' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Block_Title' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Relational_Taxonomy' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Advance_Form' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Advance_Video' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Field_Date_Range_Picker' );
		acf_register_field_type( '\StoneStomper\Acf\Acf_Fields\Acf_Media_Box' );
	}
