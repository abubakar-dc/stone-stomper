...
/***/ "./src/block-assets/default-blocks/buttons.jsx":
/*!*****************************************************!*\
  !*** ./src/block-assets/default-blocks/buttons.jsx ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function addCustomAttributes(settings, name) {
  if (name === 'core/button') {
    if (settings.attributes) {
      settings.attributes.colorVariation = {
        type: 'string',
        default: ''
      };
      settings.attributes.sizeVariation = {
        type: 'string',
        default: ''
      };
    }
...
wp.hooks.addFilter('blocks.registerBlockType', 'custom/button-attributes', addCustomAttributes);
const withCoreButtonControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    const {
      attributes,
      setAttributes,
...
wp.hooks.addFilter('editor.BlockEdit', 'custom/button-enhancements', withCoreButtonControls);
function applyExtraClass(extraProps, blockType, attributes) {
  if (blockType.name === 'core/button') {
    if (attributes.colorVariation) {
      extraProps.className = [extraProps.className, `is-color-${attributes.colorVariation}`].filter(Boolean).join(' ');
    }
    if (attributes.sizeVariation) {
      extraProps.className = [extraProps.className, `is-size-${attributes.sizeVariation}`].filter(Boolean).join(' ');
    }
  }
  return extraProps;
}
wp.hooks.addFilter('blocks.getSaveContent.extraProps', 'custom/add-variation-classes', applyExtraClass);

/***/ }),

/***/ "./src/block-assets/default-blocks/spacers.jsx":
/*!*****************************************************!*\
  !*** ./src/block-assets/default-blocks/spacers.jsx ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const withCoreSpacer = createHigherOrderComponent(BlockEdit => {
  return props => {
    ...
    let defaultValue = '';
    const spacingSizes = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useSettings)('spacing.spacingSizes');
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/container/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/container/block.json");
/* harmony import */ var _block_assets_icons_Icons_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../block-assets/icons/Icons.jsx */ "./src/block-assets/icons/Icons.jsx");
/* harmony import */ var _block_assets_preview_images_default_preview_image_webp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../block-assets/preview-images/default-preview-image.webp */ "./src/block-assets/preview-images/default-preview-image.webp");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _block_assets_components_ContainerBlock_jsx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../block-assets/components/ContainerBlock.jsx */ "./src/block-assets/components/ContainerBlock.jsx");
/* harmony import */ var _block_assets_default_blocks_buttons_jsx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../block-assets/default-blocks/buttons.jsx */ "./src/block-assets/default-blocks/buttons.jsx");
/* harmony import */ var _block_assets_default_blocks_spacers_jsx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../block-assets/default-blocks/spacers.jsx */ "./src/block-assets/default-blocks/spacers.jsx");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  ...
  attributes: {
    ...
    ..._block_assets_components_ContainerBlock_jsx__WEBPACK_IMPORTED_MODULE_7__.customAttributes
  },
  icon: _block_assets_icons_Icons_jsx__WEBPACK_IMPORTED_MODULE_4__["default"].container,
  edit: Edit,
  /**
   * @see ./save.js
   */
...
function Edit(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)("div", {
    ...blockProps,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_block_assets_components_ContainerBlock_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], {
      props: props,
      customClass: classes,
...
function Save(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Fragment, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_block_assets_components_ContainerBlock_jsx__WEBPACK_IMPORTED_MODULE_7__.ContainerBlockContent, {
      props: props,
      customClass: classes,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InnerBlocks.Content, {})
    })
  });
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkstonestomperpack"] = self["webpackChunkstonestomperpack"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["container/style-index"], () => (__webpack_require__("./src/container/index.jsx")))
