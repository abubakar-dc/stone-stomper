...
$sts_var_posttitle = $sts_fields['sts_var_posttitle'] ?? get_the_title();
...
<section id="hero-section" class="hero-section hero-section-default">
	...
	<div class="hero-ctn">
		<div class="wrapper">
			<h1><?php echo esc_html( $sts_var_posttitle ); ?></h1>
		</div>
	</div>
	<!-- Hero End -->
</section>
				...
				if ( 'random' === $sts_var_rp_selection_criteria ) {
					...
					<h3><?php esc_html__( 'Related Posts', 'basetheme_td' ); ?></h3>
						...
						foreach ( $sts_var_selected_posts as $sts_var_post ) {
							...
							$sts_post_fields = get_fields( get_the_ID() );
							$sts_var_src     = wp_get_attachment_image_url( get_post_thumbnail_id( $sts_var_post_id ), 'thumb_600', false );
							if ( ! $sts_var_src ) {
								$sts_var_src = get_template_directory_uri() . '/assets/build/images/admin/defaults/default-image.webp';
							}
								get_template_part( 'partials/content', 'archive-post' );
						}
						?>
