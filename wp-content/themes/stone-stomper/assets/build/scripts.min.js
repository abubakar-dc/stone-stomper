...
jQuery(function () {
  ...
  jQuery('#clear-order-form').on('click', function () {
    ...
    jQuery('#bar_q_shank_41, #bar_q_do35_do45, #bar_q_adjustable_hitch, #bar_q_tongue_85').val('').trigger('change');
    jQuery('#bar_options').val('').trigger('change');

    // clear hidden fields
    jQuery('#question_bar_option_value, #question_hitch_measurement, #bar_option_value, #sts_var_caravan_bar_option').val('');

    // clear measurement
    jQuery('#additional_hitch_measurement').val('').prop('required', false).attr('placeholder', 'eg. 300 mm');
