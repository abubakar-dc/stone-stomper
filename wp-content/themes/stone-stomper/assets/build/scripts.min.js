...
jQuery(document).ready(function () {
  ...
  jQuery(document).on('change blur', '#vehicle-details input, #vehicle-details select, #vehicle-details textarea', function () {
  ...
  function forceHideOnBarAndBracketValues() {
    jQuery('.hide-on-bar-and-bracket').find('input, select, textarea').each(function () {
      jQuery(this).val('').prop('required', false);
    });
  }
  jQuery(document).on('change', '#product_type', function () {
    ...
    const supportMeasurementFields = '#final-measurements .ss-support-options input,' + '#final-measurements .ss-support-options select,' + '#final-measurements .ss-support-options textarea';
  ...
  jQuery(document).on('input change', '.hide-on-bar-and-bracket input, .hide-on-bar-and-bracket select, .hide-on-bar-and-bracket textarea', function () {
...
jQuery(function () {
  ...
  jQuery('#bar_options').on('change', function () {
    ...
    const optionThree = ['Option 3 Standard Shank', 'Option 3 Adjustable Shank'];
