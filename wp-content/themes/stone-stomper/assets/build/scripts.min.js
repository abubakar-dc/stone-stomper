      ...
      success(response) {
        ...
        if (response) {
          ...
          if (response.toolbox_image) {
            jQuery('#caravan-images').append('<div class="vehicle-image">' + response.toolbox_image + '</div>').trigger('change');
          }
          jQuery('.loader-container').hide();
        }
        // selectModel();
...
/* harmony import */ var _vendors_slick_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../vendors/slick.min */ "./assets/src/js/vendors/slick.min.js");
/* harmony import */ var _vendors_slick_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendors_slick_min__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../vendors/lity.js */ "./assets/src/js/vendors/lity.js");
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendors_lity_js__WEBPACK_IMPORTED_MODULE_4__);
/**
 * Sticky Header
  ...
  const R = {
    ...
    slideNext(e, t, s) {
      ...
      if (r.loop) {
        ...
        if (a.loopFix({
          direction: 'next'
        }), a._clientLeft = a.wrapperEl.clientLeft, a.activeIndex === a.slides.length - 1 && r.cssMode) {
          return requestAnimationFrame(() => {
