...
jQuery(document).ready(function () {
  jQuery('#veh_make').on('change', function () {
    if (jQuery(this).val() === 'other') {
      ...
      vehMakeContainer.append('<input placeholder="Other Make" id="veh_make_other" name="vehicle_make_other" type="text" />');
      vehModelContainer.append('<input style="margin-top:10px" placeholder="Vehicle Model" id="vehicle_model_other" name="vehicle_model" type="text" />');
      // Append input if not already present
      yearContainer.append('<input placeholder="Model Year" id="veh_year_other" name="vehicle_year" type="text" />');
    } else {
  ...
  jQuery('#van_make').on('change', function () {
    if (jQuery(this).val() === 'other') {
      ...
      vanModelContainer.append('<input placeholder="Caravan Model" id="van_model_other" name="caravan_model" type="text" />');
    } else {
...
jQuery(document).ready(function () {
  ...
  function checkCaravanDetails() {
    let allFilled = true;
    jQuery('.grid.cols-2.caravan-details select[required]:visible, .grid.cols-2.caravan-details input[required]:visible').each(function () {
      const val = jQuery(this).val();
  ...
  jQuery(document).on('change input', '.grid.cols-2.caravan-details select[required], .grid.cols-2.caravan-details input[required]', function () {
...
jQuery(document).ready(function () {
  ...
  function verifyCaravanSection() {
    ...
    jQuery('#blk-caravan select[required]:visible, #blk-caravan input[required]:visible').each(function () {
      const fieldValue = jQuery(this).val();
      const selectedText = jQuery(this).find('option:selected').text().trim();
      if (!fieldValue || fieldValue === '' || selectedText.startsWith('Select')) {
  ...
  jQuery(document).on('change input', '#blk-caravan select[required], #blk-caravan input[required]', function () {
...
jQuery(document).ready(function () {
  ...
  function allPhotosFilled() {
    let filled = true;
    jQuery('#blk-photos select[required]:visible, #blk-photos input[required]:visible, #blk-photos input[type="file"][required]').each(function () {
      const val = jQuery(this).val();
  ...
  function allMeasureFilled() {
    let filled = true;
    jQuery('#blk-measure select[required]:visible, #blk-measure input[required]:visible').each(function () {
      const val = jQuery(this).val();
      const txt = jQuery(this).find('option:selected').text().trim();
      if (!val || val === '' || txt.startsWith('Select')) {
        filled = false;
      ...
      if (!photosDone) {
        ...
        setTimeout(() => {
          if (allMeasureFilled()) {
            ...
            document.querySelector('#final-summary').scrollIntoView({
              behavior: 'smooth',
              block: 'start'
            });
          } else {
  ...
  jQuery(document).on('change input', '#blk-photos select[required], #blk-photos input[required], #blk-photos input[type="file"][required]', function () {
    clearTimeout(timer);
    timer = setTimeout(checkPhotos, 300);
  });
  jQuery(document).on('change input', '#blk-measure select[required], #blk-measure input[required]', function () {
    clearTimeout(timer);
