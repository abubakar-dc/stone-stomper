        ...
        if (response) {
          if (yearRequested) {
            ...
            if (restoringFromCookie && cookieData.veh_model) {
              jQuery('#veh_model').val(cookieData.veh_model).trigger('change');
            }
          }
...
jQuery(function () {
  ...
  function restoreAllFields(data) {
    Object.keys(data).forEach(function (key) {
      ...
      if (type === 'checkbox') {
        ...
        jQuery('[name="' + key + '"][value="' + data[key] + '"]').prop('checked', true).trigger('change');
      } else {
  ...
  function removeSectionDisable() {
    jQuery('.section-disable').each(function () {
      jQuery(this).removeClass('section-disable').find('input, select, textarea, button').prop('disabled', false);
    });
  }
  function addSectionDisable() {
    jQuery('[data-section-lock="true"]').each(function () {
      jQuery(this).addClass('section-disable').find('input, select, textarea, button').prop('disabled', false);
    });
  }
