...
jQuery(function () {
  ...
  function reapplyMeasurements(savedData) {
    const keys = ['barwidth_mm', 'a_frame_length_mm', 'toolbox_width_mm', 'toolbox_length_mm', 'stoneguard_width_mm', 'stoneguard_length_mm', 'support_pocket_length_mm', 'vinyl_width_mm', 'vinyl_length_mm', 'additional_hitch_measurement'];
    keys.forEach(key => {
  ...
  function restoreDependentSelects(savedData, done) {
    ...
    if (savedData.vehicle_make) {
      tasks.push(waitForOptionPromise('#veh_make', savedData.vehicle_make).then(() => {
    ...
    if (savedData.caravan_make) {
      tasks.push(waitForOptionPromise('#van_make', savedData.caravan_make).then(() => {
...
jQuery(document).ready(function () {
  ...
  validateBarOptions({
    target: document.querySelector('#bar-options-section')
  });
