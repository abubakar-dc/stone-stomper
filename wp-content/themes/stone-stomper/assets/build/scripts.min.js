...
var map = {
	"./ajax-fetch-form-data.js": "./assets/src/js/partials/ajax-fetch-form-data.js",
	"./ajax-fields-validation.js": "./assets/src/js/partials/ajax-fields-validation.js",
	"./ajax-single-product.js": "./assets/src/js/partials/ajax-single-product.js",
	"./ajax-woocommerce.js": "./assets/src/js/partials/ajax-woocommerce.js",
	"./cookies-data.js": "./assets/src/js/partials/cookies-data.js",
...
/***/ "./assets/src/js/partials/ajax-fetch-form-data.js":
/*!********************************************************!*\
  !*** ./assets/src/js/partials/ajax-fetch-form-data.js ***!
  \********************************************************/
/***/ (() => {
  ...
  function fetchFormData() {
    ...
    jQuery.ajax({
      ...
      data: {
        ...
        postID,
        selectedYear,
        // actual selected year value ('' when none)
      ...
      success(response) {
        if (response) {
          ...
          if (response.stoneguard_image) {
            jQuery('#caravan-images').html('<div class="vehicle-image">' + response.stoneguard_image + '</div>').trigger('change');
          }
          jQuery('.loader-container').hide();
        }
        // selectModel();
...
/***/ "./assets/src/js/partials/ajax-fields-validation.js":
/*!**********************************************************!*\
  !*** ./assets/src/js/partials/ajax-fields-validation.js ***!
  \**********************************************************/
/***/ (() => {
...
jQuery(document).ready(function ($) {
  ...
  function validatePhotoUploads() {
    ...
    const fields = [{
      id: 'hitch_ids',
      label: 'Hitch Photograph'
    }, {
      id: 'rear_ids',
      label: 'Towing Vehicle Rear Photograph'
    }, {
      id: 'front_ids',
      label: 'Front of Caravan Photograph'
    }];
...
/***/ "./assets/src/js/partials/ajax-single-product.js":
/*!*******************************************************!*\
  !*** ./assets/src/js/partials/ajax-single-product.js ***!
  \*******************************************************/
/***/ (() => {
...
/***/ "./assets/src/js/partials/ajax-woocommerce.js":
/*!****************************************************!*\
  !*** ./assets/src/js/partials/ajax-woocommerce.js ***!
  \****************************************************/
/***/ (() => {
...
jQuery(document).ready(function () {
  ...
  function UpdateSummary() {
    ...
    console.log('➡️ UpdateSummary triggered', {
      ids,
      barwidth,
      aFrame
    });
...
/***/ "./assets/src/js/partials/cookies-data.js":
/*!************************************************!*\
  !*** ./assets/src/js/partials/cookies-data.js ***!
  \************************************************/
/***/ (() => {
...
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vendors/lity.js */ "./assets/src/js/vendors/lity.js");
/* harmony import */ var _vendors_lity_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendors_lity_js__WEBPACK_IMPORTED_MODULE_1__);
/**
 * Sticky Header
...
jQuery(document).ready(function () {
  ...
  function allRequiredFilled(section) {
    let filled = true;
    jQuery(section).find('input:visible[required], select:visible[required], textarea:visible[required]').each(function () {
      const el = jQuery(this);
      const value = el.val();
      if (!value || value.trim() === '') {
        filled = false;
  ...
  jQuery('#van_model').on('change', function () {
    ...
    validateCaravanDetails({
      target: jQuery('#van_model')[0]
    });
  });
  jQuery('#veh_make').trigger('change');
  jQuery('#van_make').trigger('change');
  validateJump01({
    target: document.querySelector('#jump-01')
  });
  validateVehicleDetails({
    target: document.querySelector('#vehicle-details')
  });
  validateCaravanDetails({
    target: document.querySelector('#caravan-details')
  });
});
jQuery(function () {
  /**
